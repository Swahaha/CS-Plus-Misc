...
#             preds = map_predictions(preds)  # Map predictions back to 0, 100, 200
...
#     opts.num_classes = 3  # Set number of classes for your dataset
...
from torch.utils import data
from torch.utils.data import Dataset  # Ensure this import is included
from datasets import VOCSegmentation, Cityscapes
from utils import ext_transforms as et
from metrics import StreamSegMetrics
...
def get_dataset(opts):
    ...
    if opts.dataset == 'voc':
        ...
        train_dst = MapSegmentationDataset(root=opts.data_root, split='train', transforms=train_transform)
