...
class ImagePairDataset(Dataset):
    def __init__(self, image_dir, correspondence_dir, pairs, transform=None):
    ...
    def __getitem__(self, idx):
        ...
        img1_path = f"{self.image_dir}/{img1_name}"
        img2_path = f"{self.image_dir}/{img2_name}"
        corr_path = f"{self.correspondence_dir}/{corr_file}"
        ...
        return img1, img2, correspondences
