...
# # 1. data config
# # training and validating
# _CN.DATASET.TRAINVAL_DATA_SOURCE = "Custom"  # options: ['ScanNet', 'MegaDepth', 'Custom']
# _CN.DATASET.TRAIN_DATA_ROOT = None
# _CN.DATASET.TRAIN_POSE_ROOT = None  # (optional directory for poses)
# _CN.DATASET.TRAIN_NPZ_ROOT = None
# _CN.DATASET.TRAIN_LIST_PATH = None
...
# _CN.DATASET.VAL_INTRINSIC_PATH = None
# # testing
# _CN.DATASET.TEST_DATA_SOURCE = "Custom"
# _CN.DATASET.TEST_DATA_ROOT = None
# _CN.DATASET.TEST_POSE_ROOT = None  # (optional directory for poses)
# _CN.DATASET.TEST_NPZ_ROOT = None
# _CN.DATASET.TEST_LIST_PATH = None   # None if test data from all scenes are bundled into a single npz file
# _CN.DATASET.TEST_INTRINSIC_PATH = None
# _CN.DATASET.CORRESPONDENCES_ROOT = None  # Directory containing the correspondences

# _CN.DATASET.TRAINVAL_DATA_SOURCE = "Custom"
# _CN.DATASET.TRAINVAL_DATA_SOURCE = "Custom"
# _CN.DATASET.TRAIN_DATA_ROOT = "dataa/images"
# _CN.DATASET.CORRESPONDENCES_ROOT = "dataa/correspondences"
# _CN.DATASET.VAL_DATA_ROOT = "dataa/images"
# _CN.DATASET.VAL_CORRESPONDENCES_ROOT = "dataa/correspondences"
# _CN.DATASET.TEST_DATA_ROOT = "dataa/images"
# _CN.DATASET.TEST_CORRESPONDENCES_ROOT = "dataa/correspondences"
...
# training and validating
_CN.DATASET.TRAINVAL_DATA_SOURCE = "Custom"  # options: ['ScanNet', 'MegaDepth', 'Custom']
_CN.DATASET.TRAIN_DATA_ROOT = "dataa/feature_matching"
_CN.DATASET.VAL_DATA_ROOT = "dataa/feature_matching_val"
_CN.DATASET.TEST_DATA_ROOT = "dataa/feature_matching_val"  # Default test data to be the same as validation data

_CN.DATASET.TRAIN_PKL_FILE = "dataa/feature_matching/data.pkl"
_CN.DATASET.VAL_PKL_FILE = "dataa/feature_matching_val/data.pkl"
_CN.DATASET.TEST_PKL_FILE = "dataa/feature_matching_val/data.pkl"
